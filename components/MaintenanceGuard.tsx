...
const PROTECTED_PREFIXES = ["/admin", "/login", "/maintenance", "/api"];
  ...
  if (!allowed) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-3 max-w-md text-muted">المتجر تحت الصيانة — هنرجع قريب إن شاء الله!</p>
